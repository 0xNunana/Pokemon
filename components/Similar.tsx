...
const SimilarSection = ({ info, complete }: { info: PokemonDetails, complete: PokemonDetails[] }) => {
    ...
    return (
        <div className='bg-[#D9D9D9]/30 max-sm:w-[200px] w-full py-10'>
            ...
            <div className='sm:w-[510px] mx-auto mt-10 '>
                <div className='grid sm:grid-cols-2 gap-3 max-sm:space-y-8 '>
                    {similarPokemons.map((pokemon, i) => (
                        <div key={i} className='bg-white rounded-[20px] relative  border group-hover:border-b-0 group-hover:rounded-b-0 max-sm:w-[180px] w-[220px] max-sm:h-[120px] h-[169px] p-2'>
                ...
                '>
                        ...
                        <div className='bg-[#F1F1F1] max-sm:h-[80px] h-[114px] rounded-[14px]' />
